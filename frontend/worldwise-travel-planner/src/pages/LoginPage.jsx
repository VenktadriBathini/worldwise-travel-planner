...
import landingPageBg from "../assets/landingpage-bg-image.jpg"; // Import background image
  ...
  return (
    ...
    >
      ...
      <form
        ...
        className="w-full max-w-sm rounded-2xl bg-slate-900/80 p-6 shadow-[0_0_0_1px_rgba(255,255,255,0.06)] backdrop-blur-xl relative z-10"
      >
        ...
        <div className="relative">
          ...
          {error && (
            <div className="mt-4 rounded-md bg-red-900/60 px-3 py-2 text-sm text-red-100">
              {error}
            </div>
          )}
